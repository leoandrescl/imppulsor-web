...
<header class="site-header">
  <div class="header-inner container">
    ...
    <!-- Botón (solo móvil) -->
    <button class="mobile-search-toggle" aria-label="Buscar">
    ...
    <div class="header-buttons">
      <a href="/contacto" class="btn btn-terciario">Contacto</a>
    </div>
  ...
  <nav class="mobile-menu">
    <button class="mobile-close" aria-label="Cerrar menú"><i data-lucide="x"></i></button>
    <?php
      $imppulsor_mobile_menu_lang = static function ($items, $args) {
        ...
        $items .= '<li class="menu-item menu-item-language mobile-menu-lang" aria-label="' . esc_attr__('Seleccionar idioma', 'imppulsorv2') . '">' . $lang . '</li>';
        return $items;
      };
...
<div id="searchModal" class="searchfs" aria-hidden="true">
  ...
  <div class="searchfs__stage" role="dialog" aria-modal="true">
    <button class="searchfs__close" type="button" aria-label="Cerrar"><i data-lucide="x"></i></button>
    ...
    <form class="searchfs__form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
      ...
      <input type="search" name="s" placeholder="Escribe y presiona Enter…" autocomplete="off">
    </form>
  </div>
</div>
<!-- Modal de búsqueda fullscreen fin -->
