<?php
/**
 * Template Name: Estrategia y Gobierno
 * Description: Página Estrategia y Gobierno — versión adaptada web (texto actualizado desde PDF).
 */
if (!defined('ABSPATH'))
  exit;
get_header();
...
<main class="page-areas-gestion page-estrategia-y-gobierno">
  ...
  <section class="section section-3 fade-in spp-section py-0"
    ...
    <div class="spp-bg-container">
      <img src="/wp-content/uploads/section-9-parallax--1.jpg" alt="" class="spp-bg-image">
    </div>
  </section>
