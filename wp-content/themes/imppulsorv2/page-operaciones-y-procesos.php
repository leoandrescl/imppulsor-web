<?php
/**
 * Template Name: Operaciones y procesos
 * Description: Página Operaciones y procesos — versión adaptada web (texto actualizado desde PDF).
 */
if (!defined('ABSPATH'))
  exit;
get_header();
...
<main class="page-areas-gestion page-operaciones-y-procesos">
  ...
  <section class="section section-9 bg-light fade-in spp-section"
    ...
    <div class="spp-bg-container">
      <img src="/wp-content/uploads/section-9-parallax--7.jpg" alt="" class="spp-bg-image">
    </div>
  </section>
