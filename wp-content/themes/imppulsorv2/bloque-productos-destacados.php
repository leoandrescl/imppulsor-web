...
$productos_destacados = [
  [
    'titulo_seccion' => '¿Sabe qué está limitando realmente su operación comercial?',
    'producto_titulo' => 'Diagnóstico de Madurez Comercial (DMC)',
    'producto_texto' => 'Evalúa con rigor el nivel de madurez de su función comercial a partir de un marco de 12 dimensiones, con evidencia cualitativa y cuantitativa para priorizar mejoras con impacto real.',
  ...
  <div class="container bg-light text-dark">
    <div class="bpd-card__header btvc-header">
      <div class="btvc-header__text bpd-card__header__text">
        <span class="badge bg-light-blue px-40 text-bold">Productos destacados</span>
      </div>
            ...
            <div class="swiper-slide">
              <div class="bpd-main grid-2">
                ...
                <div class="bpd-col bpd-col--visual">
                  <h3 class="heading-sm bpd-producto__titulo bpd-visual__titulo">12 Dimensiones Evaluadas en 3 Focos de Análisis</h3>
