<?php
/**
 * Template Name: Crecimiento MK y Productividad Comercial
 * Description: Página Crecimiento MK y Productividad Comercial — estructura base siguiendo Impulsor v2.
 */
if (!defined('ABSPATH'))
  exit;
get_header();
