                ...
                options: {
                    ...
                    scales: {
                        r: {
                            ...
                            grid: { color: '#e0e0e0', circular: true, lineWidth: 1 },
                            angleLines: { color: '#f0f0f0', lineWidth: 1 },
                    ...
                    onHover: (event, chartElements) => {
                        ...
                        if (rScale) {
                            ...
                            hoveringLabelIndex = closestIndex;
                        }
                        ...
                        if (hoveringLabelIndex !== -1) {
                            ...
                            if (labelX < (xCenter - threshold)) tooltip.classList.add('anchored-right');
                            else if (labelX > (xCenter + threshold)) tooltip.classList.add('anchored-left');
                            else {
                                if (labelY < yCenter) tooltip.classList.add('anchored-bottom');
                                else tooltip.classList.add('anchored-top');
                            }
