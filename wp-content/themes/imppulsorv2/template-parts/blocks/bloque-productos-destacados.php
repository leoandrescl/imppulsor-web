...
<style id="bpd-fade-in-critical">
  #bloque-productos-destacados.fade-in:not(.visible) {
    opacity: 0;
    transform: none;
  }
</style>
            ...
            <div class="swiper-slide">
              <div class="bpd-main grid-2">
                <div class="bpd-col bpd-col--text text-dark">
                  ...
                  <h3 class="heading-sm fs-20 mb-20"><?php echo esc_html($pd['lista_titulo']); ?></h3>
...
<style>
  ...
  #bloque-productos-destacados .badge.bg-light-blue {
  ...
  /* Normal: fondo azul, icono blanco (también cuando Swiper marca disabled/lock) */
  ...
  #bloque-productos-destacados .btvc-nav-btn.swiper-button-lock {
  ...
  /* Sin estado disabled visual ni bloqueo de hover (flechas de adorno con 1 slide) */
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-disabled,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-lock {
  ...
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-disabled::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-lock::after {
    color: #fff !important;
  }

  /* Hover / foco: círculo blanco, borde negro, flecha negra (incl. si Swiper añade disabled) */
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn:hover,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn:focus-visible,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-disabled:hover,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-lock:hover,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-disabled:focus-visible,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-lock:focus-visible {
    background: #fff !important;
    border-color: #000 !important;
  }

  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn:hover::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn:focus-visible::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-disabled:hover::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-lock:hover::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-disabled:focus-visible::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn.swiper-button-lock:focus-visible::after {
    color: #000 !important;
  }

  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn--prev:hover::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn--prev:focus-visible::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn--prev.swiper-button-disabled:hover::after,
  #bloque-productos-destacados .btvc-header__nav .btvc-nav-btn--prev.swiper-button-lock:hover::after {
    transform: rotate(180deg) !important;
  }
...
/* 1. BOTÓN PRIMARIO: normal azul claro, hover #030e23 */
...
#bloque-productos-destacados .bpd-btn--primary:focus-visible {
    background: #030e23 !important;
    color: #fff !important;
    border-color: #030e23 !important;
}
...
/* 2. BOTONES GHOST: normal blanco/negro, hover azul claro */
...
#bloque-productos-destacados .bpd-btn--ghost img.bpd-btn__arrow-img {
...
#bloque-productos-destacados .bpd-btn--ghost:hover img.bpd-btn__arrow-img,
#bloque-productos-destacados .bpd-btn--ghost:focus-visible img.bpd-btn__ico--img,
#bloque-productos-destacados .bpd-btn--ghost:focus-visible img.bpd-btn__arrow-img {
    filter: brightness(0) invert(1) !important;
}
  ...
  /* Tres filas: azul claro unificado */
  ...
  .bpd-barra__item:hover .bpd-barra__icon,
  .bpd-barra__item:focus-within .bpd-barra__icon {
  ...
  @media (max-width: 576px) {
    ...
    /* Una sola columna: sin separadores verticales (992px aún aplicaba border-right en impares). */
    .bpd-barra__item:nth-child(odd) {
      border-right: none;
    }

    /* Restaurar líneas entre filas (992px quitaba border-bottom a los 2 últimos como si fuera grid 2×2). */
    .bpd-barra__item:nth-last-child(-n + 2) {
      border-bottom: 3px solid #006eff;
    }
...
<script>
  (function () {
    function initBpdReveal() {
      ...
      if (!root || !root.classList.contains('fade-in') || root.dataset.bpdRevealInit) return;
  ...
  document.addEventListener('DOMContentLoaded', function () {
    function initBpdSwiper() {
      ...
      function bpdKeepNavButtonsDecorative() {
      ...
      bpdKeepNavButtonsDecorative();
      swiper.on('slideChange transitionEnd resize observerUpdate', bpdKeepNavButtonsDecorative);
    }
