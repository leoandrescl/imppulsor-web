<?php
/**
 * Template Name: Cambio y Transformación
 * Description: Página Cambio y Transformación — versión adaptada web (texto actualizado desde PDF).
 */
if (!defined('ABSPATH'))
  exit;
get_header();
...
<main class="page-areas-gestion page-cambio-y-transformacion">
  ...
  <section class="section section-9 bg-light fade-in spp-section"
    ...
    <div class="spp-bg-container">
      <img src="/wp-content/uploads/section-9-parallax--5.jpg" alt="" class="spp-bg-image">
    </div>
  </section>
