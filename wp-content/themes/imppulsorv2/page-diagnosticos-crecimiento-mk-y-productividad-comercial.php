<?php
/**
 * Template Name: Diagnosticos para Crecimiento MK y Productividad Comercial
 * Description: Página Diagnosticos para Crecimiento MK y Productividad Comercial — estructura base siguiendo Impulsor v2.
 */
if (!defined('ABSPATH'))
  exit;
get_header();
...
<main class="page-areas-gestion page-comercial-clientes">
  ...
  <section class="section section-2 bg-light pb-0 fade-in">
  ...
  <section class="section pt-0 pb-0 section-2 bg-light fade-in">
    <div class="container text-dark">
  ...
  <section class="section bg-light section-8 pt-0 pb-0 fade-in text-dark">
    <div class="container">
