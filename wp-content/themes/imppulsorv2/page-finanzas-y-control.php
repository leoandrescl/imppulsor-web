<?php
/**
 * Template Name: Finanzas y Control
 * Description: Página Finanzas y Control — versión adaptada web (texto actualizado desde PDF).
 */
if (!defined('ABSPATH'))
  exit;
get_header();
...
<main class="page-areas-gestion page-finanzas-y-control">
  ...
  <section class="section section-9 bg-light fade-in spp-section"
    ...
    <div class="spp-bg-container">
      <img src="/wp-content/uploads/section-9-parallax--2.jpg" alt="" class="spp-bg-image">
    </div>
  </section>
